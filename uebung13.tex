...
{\tiny\emph{Hinweis:} Die Ringgarbe~$\O_X$ ist die Garbe der glatten reellwertigen
...
D(f)$ für eine von~$f \in \O_{X,x_0}$ abhängige Zahl~$D(f)$ -- wieso?\par}
...
den Term~$p(x_0 + \varepsilon \cdot v) \in \dualnumbers$ auswerten.\par}
\end{aufgabe}
