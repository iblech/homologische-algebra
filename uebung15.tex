...
\begin{center}\framebox{$\renewcommand{\arraystretch}{1.3}\begin{array}{@{}lcl@{}}
  I \models x = x' &\Ll&
    \text{Für die gegebenen Elemente $x, x' : I \to X$ gilt $x = x'$.} \\
  I \models \top &\Ll&
    \text{Stets erfüllt.} \\
...
beiden Fällen einen verschiedenen Charakter haben.\par}
\end{aufgabe}
...
\end{itemize}
Sei eine Prägarbe~$\F$ durch~$\Gamma(U,\F) \defeq \{ f : U \to A \,|\, \varphi(f)
