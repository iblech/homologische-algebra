...
ist der globale-Schnitte-Funktor $\Gamma : \AbSh(X) \to \Ab$. Sei~$X = A \cup B$
...
\end{enumerate}
\end{aufgabe}
% Spektralsequenz durch die aus Remark 2.67 von Huybrechts/FM ersetzen?
...
http://ncatlab.org/nlab/show/tensor+product+of+chain+complexes
für Balancierung von Tor
